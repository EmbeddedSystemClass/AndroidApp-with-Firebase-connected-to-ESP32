...
public class fragmentB extends Fragment {
    ...
    public View onCreateView( LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lista = (ListView) view.findViewById(R.id.list_analog);
        sv = (SearchView) view.findViewById(R.id.searchView2);
        adapter = new ArrayAdapter<String>(getActivity(),android.R.layout.simple_dropdown_item_1line,dados);
        lista.setAdapter(adapter);
        sv.setQueryHint("Search..");
        firebase = ConfiguracaoFirebase.getFirebase().child("AnalogList");
